...
def main():
    ...
    source = init_source(args)
    audio_model = init_model(args)
    ...
    while True:
        try:
            ...
            if not audio_data_queue.empty():
                ...
                if time_of_last_sample and now - time_of_last_sample > timedelta(seconds=phrase_timeout):
                    last_sample = bytes()
